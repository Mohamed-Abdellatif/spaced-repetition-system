...
export const questionsApi = {
  ...
  getQuestionsByIds: async (questionsList: number[]) => {
    const response = await axios.post(`${dataURL}/getQuestionsById`, {
      questionsList,
    });
    return response.data;
  },

  checkQuestionById: async (
    userId: string,
    question: string,
    answer: string
  ) => {
    const response = await axios.post(
      `${dataURL}/checkQuestionExistenceOnUser`,
      {
        userId,
        question,
        answer,
  ...
  searchQuestions: async (searchText: string, userId: string) => {
    const response = await axios.post(
      `${dataURL}/searchQuestions/${searchText}`,
      { userId }
    );
    return response.data;
  },
...
export const listsApi = {
  getList: async (listName: string, userId: string) => {
    const response = await axios.post(`${dataURL}/getList/${listName}`, {
      userId,
    });
  ...
  getPublicList: async (listName: string, userId: string) => {
    const response = await axios.post(`${dataURL}/getPublicList/${listName}`, {
      userId,
    });
    return response.data[0];
  },
  ...
  searchLists: async (searchText: string, userId: string) => {
    const response = await axios.post(`${dataURL}/searchLists/${searchText}`, {
      userId,
    });
    return response.data;
  },
  ...
  searchPublicLists: async (searchText: string, userId: string) => {
    const response = await axios.post(
      `${dataURL}/searchPublicLists/${searchText}`,
      { userId }
    );
    return response.data;
  },
...
export const imagesApi = {
  ...
  uploadImageAsQuestion: async (questionId: number, formData: any) => {
    const response = await axios.put(
      `${dataURL}/uploadAsQuestion/${questionId}`,
      formData
    );
    return response.data;
  },
  ...
  getImageAsQuestion: async (questionId: number) => {
    const response = await axios.get(
      `${dataURL}/questionsAsImages/${questionId}`
    );
    return response.data;
  },
  ...
  getQuestionAsImageDirect: async (questionId: number) => {
    const response = await axios.get(
      `${dataURL}/questionsAsImagesImgDirect/${questionId}`,
      {
        responseType: "blob",
      }
    );
  ...
  deleteQuestionAsImage: async (questionId: number) => {
    const response = await axios.delete(
      `${dataURL}/deleteQuestionsAsImages/${questionId}`
    );
    return response.data;
  },
};
